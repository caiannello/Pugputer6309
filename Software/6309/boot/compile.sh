...
../../../bin/tools/lwtools-4.20/lwasm/lwasm bios.asm --format=obj --output=bios.o --list=bios.lst
...
../../../bin/tools/lwtools-4.20/lwlink/lwlink --format=srec --output=pugboot.s19 --map=pugboot.map --script=linker_script helpers.o serio.o mon.o bios.o time.o main.o 
