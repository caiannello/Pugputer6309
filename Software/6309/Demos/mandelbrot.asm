...
; DESCRIPTION:
;
; DRAWS A MANDELBROT FRACTAL USING A V9958 VDP IN 256-COLOR MODE.
; 
; THIS CODE EXPECTS $8000 TO CONTAIN THE 8192 BYTE FLOATING-POINT LIBRARY
; FROM THE MC6839 FLOATING-POINT ROM
;
;------------------------------------------------------------------------------
                            ; V9958 VDP CONSTANTS 
