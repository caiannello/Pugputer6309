...
for adrs in range(0x0000,65536, 4):
  ...
  # inputs to PAL: hn3,hn2,ssf,hn1,e21,e20,e19,a3,a2
  # (not counting eclk and r//w)

  # outputs from PAL: /ram0, /ram1, /rom, /uart, /mapwr, io, xmem
  # (not counting /rd,/wr,aux0)
